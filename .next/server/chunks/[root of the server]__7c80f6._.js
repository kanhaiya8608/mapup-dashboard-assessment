...
"[project]/src/app/api/evData/route.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
(()=>{
    const e = new Error("Cannot find module 'csv-parser'");
...
;
;
const filePath = __TURBOPACK__imported__module__$5b$externals$5d2f$__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].resolve(process.cwd(), 'data-to-visualize/Electric_Vehicle_Population_Data.csv');
async function GET(req) {
    const evData = [];
    return new Promise((resolve, reject)=>{
        __TURBOPACK__imported__module__$5b$externals$5d2f$__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].createReadStream(filePath).pipe(csv()).on('data', (row)=>evData.push(row)).on('end', ()=>{
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__7c80f6._.js.map